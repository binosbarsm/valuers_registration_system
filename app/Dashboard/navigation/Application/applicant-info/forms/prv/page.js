...
import styles from "./prv.module.css"
import { useRouter } from "next/navigation"

export default function PRV({ prevStep }) {
  ...
  return (
    <div className={styles.container}>
      ...
      <h1 className={styles.title}>Application for Provisional Registration / Renewal </h1>
 ...
 <button className={styles.addBtn} onClick={addEducation}>+ Add Another Qualification</button>
            </div>
