...
import { FaEye, FaCommentDots, FaCheck } from "react-icons/fa";
...
const [commentText, setCommentText] = useState("");
 const router = useRouter();
  ...
  const applications = [
    { id: "APP-001", surname: "Do", firstName: "Johnsssssssssssssss", registrationType: "PRV", gender: "Male", controlNumber: "CN1001", phone: "0712345678", email: "john@mail.com", status: "Pending", date: "2026-03-01" },
    { id: "APP-002", surname: "Smith", firstName: "Jane", registrationType: "FRV", gender: "Female", controlNumber: "CN1002", phone: "0723456789", email: "jane@mail.com", status: "Approved", date: "2026-03-02" },
    { id: "APP-003", surname: "Hassan", firstName: "Ali", registrationType: "TV", gender: "Male", controlNumber: "CN1003", phone: "0734567890", email: "ali@mail.com", status: "Pending", date: "2026-03-03" },
    { id: "APP-004", surname: "Paul", firstName: "Mary", registrationType: "Firm", gender: "Female", controlNumber: "CN1004", phone: "0745678901", email: "mary@mail.com", status: "Rejected", date: "2026-03-04" }
  ];
  ...
  // Excel-like column resizing (client only)
  useEffect(() => {
    ...
    router.push(`/boarddashboard/navigation/submission/${id}`)
  }

  //comment and approve modals
...
const openApproveModal = (e, app) => {
  ...
  return (
    <div className={styles.container}>
      <p className={styles.title}>A list of application forms submitted by valuers based on recent data</p>
  ...
  />
      ...
      <div className={styles.tableWrapper} style={{overflowX:"auto"}}>
        <table ref={tableRef} className={styles.table}>
          <thead>
            <tr>
              <th onClick={() => handleSort("id")}>Applicant ID{getArrow("id")}</th>
              ...
              <th onClick={() => handleSort("controlNumber")}>Control No. {getArrow("controlNumber")}</th>
...
>
                <td data-label="Applicant ID">{app.id}</td>
                <td data-label="Surname">{app.surname}</td>
                <td data-label="First Name">{app.firstName}</td>
                <td data-label="Registration Type">{app.registrationType}</td>
                <td data-label="Gender">{app.gender}</td>
                <td data-label="Control Number">{app.controlNumber}</td>
                <td data-label="Phone">{app.phone}</td>
                <td data-label="Email">{app.email}</td>
                <td data-label="Status"><span className={`${styles.status} ${styles[app.status.toLowerCase()]}`}>{app.status}</span></td>
  ...
  <button
    ...
    onClick={(e) => openCommentModal(e, app)}
  >
    <FaCommentDots />
  </button>
  ...
  <button
    ...
    onClick={(e) => openApproveModal(e, app)}
  >
    <FaCheck />
  </button>
    ...
    <div className={styles.modal}>
      ...
      <div className={styles.modalActions}>
        ...
        <button
          ...
          onClick={() => {
            console.log("Comment:", commentText, selectedApp);
  ...
  <div className={styles.modalOverlay}>
    <div className={styles.modal}>
      ...
      <div className={styles.modalActions}>
        ...
        <button
          className={styles.approveConfirm}
          onClick={() => {
